/* Data-loading indicator: a truck hauling down an endless road.
   From Uiverse.io by vinodjangid07. styled-components dropped — the CSS lives in
   styles.css under "truck loader"; the cab's fill is themed via --loader-accent
   (brand orange in light, hot pink in dark). */
export function TruckLoader({ label = 'Loading…' }) {
  return (
    <div className="loader">
      <div className="truckWrapper">
        <div className="truckBody">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" className="trucksvg">
            <path className="tk-cab" strokeWidth={3} stroke="#282828" d="M135 22.5H177.264C178.295 22.5 179.22 23.133 179.594 24.0939L192.33 56.8443C192.442 57.1332 192.5 57.4404 192.5 57.7504V89C192.5 90.3807 191.381 91.5 190 91.5H135C133.619 91.5 132.5 90.3807 132.5 89V25C132.5 23.6193 133.619 22.5 135 22.5Z" />
        ...
        <div className="road" />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 453.459 453.459" className="lampPost">
...
/* Drop-in for a <tbody> that's waiting on data. */
export function TableLoader({ colSpan, label }) {
  return (
    <tr className="loader-row">
      <td colSpan={colSpan}><TruckLoader label={label} /></td>
    </tr>
  );
}
